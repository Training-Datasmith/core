...
class Agent
{
     ...
     */
    protected static $properties = ['browser' => 'unknown', 'version' => 0, 'majorver' => 0, 'minorver' => 0, 'platform' => 'unknown', 'alpha' => false, 'beta' => false, 'win16' => false, 'win32' => false, 'win64' => false, 'frames' => false, 'iframes' => false, 'tables' => false, 'cookies' => false, 'backgroundsounds' => false, 'javascript' => false, 'vbscript' => false, 'javaapplets' => false, 'activexcontrols' => false, 'isbanned' => false, 'ismobiledevice' => false, 'issyndicationreader' => false, 'crawler' => false, 'cssversion' => 0, 'aolversion' => 0];
    /**
     * @var  array  property to cache key mapping
     */
    protected static $keys = ['browser' => 'A', 'version' => 'B', 'majorver' => 'C', 'minorver' => 'D', 'platform' => 'E', 'alpha' => 'F', 'beta' => 'G', 'win16' => 'H', 'win32' => 'I', 'win64' => 'J', 'frames' => 'K', 'iframes' => 'L', 'tables' => 'M', 'cookies' => 'N', 'backgroundsounds' => 'O', 'javascript' => 'P', 'vbscript' => 'Q', 'javaapplets' => 'R', 'activexcontrols' => 'S', 'isbanned' => 'T', 'ismobiledevice' => 'U', 'issyndicationreader' => 'V', 'crawler' => 'W', 'cssversion' => 'X', 'aolversion' => 'Y'];
    /**
     * @var	array	global config defaults
     */
    protected static $defaults = ['browscap' => ['enabled' => true, 'url' => 'https://browscap.org/stream?q=Lite_PHP_BrowsCapINI', 'method' => 'wrapper', 'proxy' => ['host' => null, 'port' => null, 'auth' => 'none', 'username' => null, 'password' => null], 'file' => ''], 'cache' => ['driver' => '', 'expiry' => 604800, 'identifier' => 'fuel.agent']];
    /**
    ...
    protected static function parse_browscap()
    {
        ...
        switch (static::$config['browscap']['method']) {
            ...
            case 'wrapper':
                ...
                $context = null;
                if (!empty(static::$config['browscap']['proxy']['host']) and !empty(static::$config['browscap']['proxy']['port'])) {
                    $context = ['http' => ['proxy' => 'tcp://' . static::$config['browscap']['proxy']['host'] . ':' . static::$config['browscap']['proxy']['port'], 'request_fulluri' => true]];
                }
                ...
                try {
                    ...
                    logger(\Fuel::L_ERROR, $e->get_message());
                    $data = false;
                }
                break;
            default:
        ...
        foreach ($result as &$properties) {
            if (array_key_exists('Parent', $properties)) {
                if ($properties['Parent'] == 'DefaultProperties') {
                    unset($properties['Parent']);
                } else if (array_key_exists($properties['Parent'], $index)) {
