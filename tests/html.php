...
class Test_Html extends TestCase
{
    ...
    public function test_meta()
    {
        ...
        $meta = [
            ...
            ['name' => 'description', 'content' => 'Meta Example'],
            ['name' => 'keywords', 'content' => 'fuel, rocks'],
            ];
...
<meta name="keywords" content="fuel, rocks" />';
    ...
    public function test_anchor()
    {
        ...
        $output = Html::anchor('http://google.com', 'Go to Google', ['rel' => 'example', 'class' => 'sample', 'style' => 'color:red;']);
        $expected = '<a rel="example" class="sample" style="color:red;" href="http://google.com">Go to Google</a>';
        $this->assertEquals($expected, $output);

        // External secure uri
        $output = Html::anchor('http://google.com', 'Go to Google', ['rel' => 'example', 'class' => 'sample', 'style' => 'color:red;'], true);
        ...
        $output = Html::anchor('controller/method', 'Method', [], true);
    ...
    public function test_img()
    {
        ...
        $output = Html::img('image.png', ['alt' => 'Image']);
